...
TOOLS = [
    {"name": "Nmap", "description": "Ağ keşfi ve port taraması; savunma için ağ envanteri ve beklenmeyen servis tespiti."},
    ...
    {"name": "OWASP ZAP", "description": "Web uygulama güvenlik testi aracı; savunma ekipleri için otomatik güvenlik taramaları ve tarama sonuçları."},
    ...
    {"name": "OSQuery (again noted)", "description": "Uç nokta sorgulama için güçlü bir araç; envanter, izlemesi ve anomali tespiti."},
],
...
if __name__ == "__main__":
    print("siber_arac_v2.py — Savunma-odaklı araç listesi (100 adet)")
